...
if uploaded_files or downloaded_dfs:
    ...
    # =================== شبیه‌سازی مونت کارلو، CVaR، Married Put و پیش‌بینی تصادفی ===================
    # این کد همان کد ابزار طولانی اصلی است و اینجا به صورت یکجا آورده شده است:
    # 👇👇👇

    # ----- شبیه‌سازی و داشبورد مونت کارلو، Married Put و ... -----
